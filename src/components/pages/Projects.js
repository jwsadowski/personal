...
const projectCards = {width: "18rem"}

function Projects() {
    return (
        <>
            <div className="card" style={projectCards}>
                <img src="https://raw.githubusercontent.com/megsra17/movie-soundtrack-finder/main/Screen%20Shot%202022-10-18%20at%205.46.00%20PM.png" className="card-img-top" alt=" " />
            ...
            <div className="card" style={projectCards}>
                <img src="https://raw.githubusercontent.com/ddwk21/we-do/main/public/assets/homepage.JPG" className="card-img-top" alt=" " />
                    <div className="card-body">
